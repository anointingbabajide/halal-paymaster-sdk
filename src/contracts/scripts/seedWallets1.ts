...
//       await pool.query(
//         `INSERT INTO wallets (user_id, address, owner_address, private_key, is_active)
//          VALUES ($1, $2, $3, $4, true)
//          ON CONFLICT (address) DO NOTHING`,
//         [testUserId, smartAccountAddress, ownerAddress, privateKey],
//       );
